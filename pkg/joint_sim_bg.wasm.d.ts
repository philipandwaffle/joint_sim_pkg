...
export function wasm_bindgen__convert__closures__invoke1_mut__h14b1e6ed63b0f6c0(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h680a50f4953e34fe(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc18a548c83b5a20c(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h01f84bc11c27a64a(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2f5f1404f0c9a761(a: number, b: number, c: number): void;
